<?php
/**
 * Theme Name: Social Web Foundation
 *
...
function social_web_foundation_enqueue_styles() {
	...
	wp_enqueue_style( 'core-style', get_template_directory_uri() . '/css/core.css', array(), '1.0.0' );
	wp_enqueue_style( 'custom-style', get_template_directory_uri() . '/css/wty1xyh.css', array(), '1.0.0' );
