<?php
/**
 * Footer template for Social Web Foundation theme.
 *
	...
	<div class="content">
		<div class="footer-grid">
			<div class="footer-logo">
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/logotype.svg" alt="Footer Logo">
			</div>
		...
		<div class="footer-image-container">
			<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/small-circles-solid.svg" alt="Footer Decoration">
		</div>
	</div>
